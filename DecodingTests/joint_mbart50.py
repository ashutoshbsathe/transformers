...
generated_tokens, hi_args = model.generate(
    **encoded_hi,
    **gen_args,
)
print('\n'.join(tokenizer.batch_decode(generated_tokens['sequences'], skip_special_tokens=True)))
# => "Le chef de l 'ONU affirme qu 'il n 'y a pas de solution militaire dans la Syrie."

# translate Arabic to English
tokenizer.src_lang = "ar_AR"
encoded_ar = tokenizer(article_ar, return_tensors="pt")
generated_tokens, ar_args = model.generate(
    **encoded_ar,
    **gen_args,
)
print('\n'.join(tokenizer.batch_decode(generated_tokens['sequences'], skip_special_tokens=True)))
