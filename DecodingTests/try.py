...
# Joint decoding 
out5 = beam_search(paraphrase, **deepcopy(paraphrase_args), model2=unifiedskg.pretrain_model, model2_kwargs=unifiedskg_model_kwargs, **paraphrase_model_kwargs)
...
out6 = beam_search(unifiedskg.pretrain_model, **deepcopy(unifiedskg_args), model2=paraphrase, model2_kwargs=paraphrase_model_kwargs, **unifiedskg_model_kwargs)
